  ...
  const stepItems = [
    {
      title: "数据采集",
      status: "等待输入",
      detail: "输入 Amazon 链接后启动采集，生成产品摘要与产物。"
    },
    {
      title: "尺寸补全",
      status: "待执行",
      detail: "缺失尺寸时以 ASIN 查询供应商 API，补全字段。"
    },
    {
      title: "类目分类",
      status: "待执行",
      detail: "向量检索 + 模型判断 class，输出候选与置信度。"
    },
    {
      title: "图片重绘",
      status: "待计划",
      detail: "按类型与批次策略生成候选图，记录批次与成本。"
    },
    {
      title: "模板填充",
      status: "待执行",
      detail: "解析 Wayfair 模板并填充字段，收集缺失项。"
    },
    {
      title: "审查与导出",
      status: "待审查",
      detail: "用户确认字段与图片后导出并上传。"
    }
  ];
